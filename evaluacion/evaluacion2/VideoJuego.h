...
public:
    ...
    Estrategia(const Estrategia &obj)
    {
        nombre = new string;
        num_serie = new int;
        tipo_juego = new VideoJuego::tipo;
        number_of_players = new int;
        *nombre = *obj.nombre;
        *num_serie = *obj.num_serie;
        *tipo_juego = *obj.tipo_juego;
...
public:
    ...
    Aventura(const Aventura &obj)
    {
        nombre = new string;
        num_serie = new int;
        tipo_juego = new VideoJuego::tipo;
        rate_category = new string;
        *nombre = *obj.nombre;
        *num_serie = *obj.num_serie;
        *tipo_juego = *obj.tipo_juego;
        *rate_category = *obj.rate_category;
    }
    virtual ~Aventura()
    {
...
public:
    ...
    Aprendizaje(const Aprendizaje &obj)
    {
        nombre = new string;
        num_serie = new int;
        tipo_juego = new VideoJuego::tipo;
